...
<div class="row bar bar-third">
	...
	echo $this->Form->create('Category',array('class'=>'form')); 
		...
		echo $this->Form->input('parent_id',array('options'=>$parentCategories, 'empty'=>'Select ...', 'value'=>$this->request->data['Category']['parent_id'], 'class'=>'form-control','div'=>array('class'=>'form-group')));
