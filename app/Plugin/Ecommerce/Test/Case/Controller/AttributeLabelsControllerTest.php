<?php
App::uses('AttributeLabelsController', 'Ecommerce.Controller');

/**
 * AttributeLabelsController Test Case
 *
 */
class AttributeLabelsControllerTest extends ControllerTestCase {
