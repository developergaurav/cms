<?php
App::uses('AttributeValuesController', 'Ecommerce.Controller');

/**
 * AttributeValuesController Test Case
 *
 */
class AttributeValuesControllerTest extends ControllerTestCase {
