<?php
App::uses('ProductOrderNotesController', 'Ecommerce.Controller');

/**
 * ProductOrderNotesController Test Case
 *
 */
class ProductOrderNotesControllerTest extends ControllerTestCase {
