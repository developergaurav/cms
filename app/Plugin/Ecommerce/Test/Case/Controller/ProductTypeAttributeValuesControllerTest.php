<?php
App::uses('ProductTypeAttributeValuesController', 'Ecommerce.Controller');

/**
 * ProductTypeAttributeValuesController Test Case
 *
 */
class ProductTypeAttributeValuesControllerTest extends ControllerTestCase {
