<?php
App::uses('RelatedProductsController', 'Ecommerce.Controller');

/**
 * RelatedProductsController Test Case
 *
 */
class RelatedProductsControllerTest extends ControllerTestCase {
