	...
	<div class="col-md-12">
		<div class="table-responsive">
			...
			<?php foreach ($attributes as $attribute): ?>
				<tr>
					<td>
						<?php $attribute['Type']['title'];?>
					</td>
					<td><?php echo h($attribute['Attribute']['title']); ?></td>
					<td><?php echo h($attribute['Attribute']['status']); ?></td>
					<td class="text-right action">
						...
						<?php echo $this->Form->postLink('<i class=\'glyphicon glyphicon-remove-circle\'></i> Delete', array('action' => 'delete', $attribute['Attribute']['id'],'admin'=>true), array('escape'=>false,'class'=>'btn btn-danger'), __('Are you sure you want to delete?')); ?>
					</td>
				</tr>
			<?php endforeach; ?>
			</tbody>
