...
<div class="row bar bar-third">
	...
	<tr>
		...
		<td><?php echo h($productOrder['ProductOrder']['client_detail']); ?>&nbsp;</td>
		<td><?php echo h($productOrder['ProductOrder']['order_detail']); ?>&nbsp;</td>
		<td><?php echo h($productOrder['ProductOrder']['payment_detail']); ?>&nbsp;</td>
		<td><?php echo h($productOrder['ProductOrder']['status']); ?>&nbsp;</td>
