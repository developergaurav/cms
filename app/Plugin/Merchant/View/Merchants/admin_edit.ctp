<div class="row bar bar-primary bar-top">
	<div class="col-md-12">
		<h1 class="bar-title"><?php echo __('Admin Edit Merchant'); ?></h1>
	</div>
</div>
...
<div class="row bar bar-third">
	<div class="col-md-12">
	<?php 
	echo $this->Form->create('Merchant',array('class'=>'form')); 
		...
		echo $this->Form->input('basic_information',array('class'=>'form-control','div'=>array('class'=>'form-group')));
