<div class="row bar bar-primary bar-top">
	...
	<div class="col-md-9 text-right">
		<?php echo $this->Form->create('Merchant',array('class'=>'searchForm','data-role'=>'form')); ?>
...
<div class="row bar bar-third">
	<div class="col-md-12">
		<div class="table-responsive">
			...
			<tr class="info">
							...
							<th><?php echo $this->Paginator->sort('basic_information'); ?></th>
	...
	<tr>
		<td><?php echo h($merchant['Merchant']['id']); ?>&nbsp;</td>
		<td><?php echo h($merchant['Merchant']['email']); ?>&nbsp;</td>
		<td><?php echo h($merchant['Merchant']['password']); ?>&nbsp;</td>
		<td><?php echo h($merchant['Merchant']['basic_information']); ?>&nbsp;</td>
		<td><?php echo h($merchant['Merchant']['status']); ?>&nbsp;</td>
		<td><?php echo h($merchant['Merchant']['created']); ?>&nbsp;</td>
		<td><?php echo h($merchant['Merchant']['modified']); ?>&nbsp;</td>
