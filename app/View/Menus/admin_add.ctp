<div class="row bar bar-primary bar-top">
	<div class="col-md-12">
		<h1 class="bar-title"><?php echo __('Admin Add Menu'); ?></h1>
	</div>
</div>
...
<div class="row bar bar-third">
	...
	<?php
		echo $this->Form->input('type',array('type'=>'select', 'data-ng-change'=>'checkMenuType()','options'=>$menu_types,'option_values'=>json_encode($menu_types), 'class'=>'form-control menu-types', 'data-ng-model'=>'menuTypes', 'div'=>array('class'=>'form-group')));
