...
<div class="row bar bar-third">
	...
	<tr>
		...
		<td>
			<?php echo String::truncate("{$webPage['WebPage']['description']}",100,array('ellipsis' => '...','exact' => false,'html' => false));?>
		</td>
		...
		<td class="text-right action">
			...
			<?php echo $this->Form->postLink('<i class=\'glyphicon glyphicon-remove-circle\'></i> Delete', array('action' => 'delete', $webPage['WebPage']['id'],'admin'=>true), array('escape'=>false,'class'=>'btn btn-danger'), __('Are you sure you want to delete?')); ?>
		</td>
	</tr>
<?php endforeach; ?>
			</tbody>
